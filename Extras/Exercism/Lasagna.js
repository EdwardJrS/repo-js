...
export function totalTimeInMinutes(numberOfLayers, actualMinutesInOven) {
  // Cada capa toma 2 minutos de preparación
  const preparationTime = numberOfLayers * 2;
  // El tiempo total es la suma del tiempo de preparación y el tiempo en el horno
  let totalWorkingTime = preparationTime + actualMinutesInOven;
